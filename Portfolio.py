...
with st.container():
    ...
    st.markdown(
        f"""
        <div style=" position : fixed; top:0 ; left:0 ; right:40 ;margin-right: 80px; margin-right: 130px; margin-left: 90px;margin-top: 36px; width: 100%; background-color: rgba(255, 255, 255, 0.8); z-index: 1000;">
            <div style="display: flex; align-items: center; justify-content: space-between;">
                <div>
                    <!-- Logo Image -->
                    <img src="https://i.imgur.com/kjwJq12.png" alt="Logo" style="width: auto; height: 24px;">
                </div>
                <div style="margin-right: 80px;display: flex; gap: 20px;">
                    <!-- Navigation Buttons -->
