...
with st.container():
    ...
    st.markdown(
        f"""
        <div style=" position : fixed; top:0 ; left :0 ; right :0 ;margin-right: 80px; margin-left: 80px;margin-top: 64px; width: 100%; background-color: rgba(255, 255, 255, 0.8); z-index: 1000;">
