...
with st.container():
    ...
    st.markdown(
        f"""
        <div style="position: fixed; margin-right: 80px; margin-left: 80px;margin-top: 64px; top: 0;right: 32;left: 0; width: 100%; background-color: rgba(255, 255, 255, 0.8); z-index: 1000;">
